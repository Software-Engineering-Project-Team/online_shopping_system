...
export const categories = [
  ...
  { name: 'Dairy & Eggs', description: 'Milk, cheese, eggs, and other dairy products', image: dairyIcon, bgColor: '#FFFFFF', link: '/dairy' },
  ...
  { name: 'Snacks', description: 'Chips, cookies, and other snack items', image: snacksIcon, bgColor: '#FFFFFF', link: '/snacks' },
  { name: 'Pantry Essentials', description: 'Canned goods, grains, pasta, and other pantry staples', image: pantryIcon, bgColor: '#FFFFFF', link: '/pantry' },
  { name: 'Breakfast & Cereals', description: 'Breakfast cereals and other morning meals', image: breakfastIcon, bgColor: '#FFFFFF', link: '/breakfast' },
  { name: 'Beverages', description: 'Soft drinks, juices, water, and alcoholic beverages', image: beveragesIcon, bgColor: '#FFFFFF', link: '/beverages' },
