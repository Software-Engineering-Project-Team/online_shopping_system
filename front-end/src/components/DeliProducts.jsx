...
const DeliProducts = ({addToCart}) => {
  return (
    
    <div className="container mx-auto py-8">
      <h2 className="text-2xl font-bold mb-6 text-center">Deli Products</h2>
          ...
          <div key={product.name} className="card bg-base-100 w-72 shadow-xl">
            ...
            <div className="card-body flex flex-col justify-between">
              ...
              <div className="card-actions flex flex-row items-center">
                <button className="btn btn-xs sm:btn-sm md:btn-md lg:btn-md m-2"onClick={() => addToCart(product)}>Add to Cart</button>
